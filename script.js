...
const translations={
  ar:{
    ...
    downloadTitle:"تحميل StudyForge PC 1.0.1",latestRelease:"Latest Release",downloadDesc:"نسخة Windows x64 — الإصدار 1.0.1",
  ...
  en:{
    ...
    downloadTitle:"Download StudyForge PC 1.0.1",latestRelease:"Latest Release",downloadDesc:"Windows x64 — version 1.0.1",
    ...
    footerHelp:"Help",changelog:"Changelog",helpBadge:"Help"
  }
};
function applyLang(lang){
  ...
  document.querySelectorAll('[data-i18n-alt]').forEach(el=>{ const k=el.getAttribute('data-i18n-alt'); if(t[k]) el.alt=t[k]; });
